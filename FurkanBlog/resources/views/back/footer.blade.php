    <footer class="footer">
        ...
        <nav class="float-left">
            ...
            <li>
                <a href="http://blog.creative-tim.com disabled">
                Blog
                </a>
            </li>
            </ul>
        ...
        <div class="copyright float-right" id="date">
            ...
            <a href="https://www.creative-tim.com" target="_blank">Furkan ERPAY</a> hazırlık projesi.
        </div>
        </div>
    </footer>
    <script>
    ...
    <script src="{{asset('back/assets/js/material-dashboard.js?v=2.1.0')}}"></script>
